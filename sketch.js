...
roof1=Bodies.rectangle(400,80,300,10,options);
World.add(world,roof1);
rope1=new Rope(bob1.body,roof1);
rope2=new Rope(bob2.body,roof1);
rope3=new Rope(bob3.body,roof1);
rope4=new Rope(bob4.body,roof1);
rope5=new Rope(bob5.body,roof1);*/
Engine.run(engine);
...
fill("yellow")
rectMode(CENTER);
 rect(roof1.position.x,roof1.position.y,300,10);
pop ();*/
